...
namespace Protocolo.Validation
{
    public class Mod11
    {
        public bool IsValid(string value, int valueValidLength, string[] maskChars, int[] multipliersForFirstDigit, int[] multipliersForSecondDigit)
        {
